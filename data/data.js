...
const spriteData = {
	...
	"cosmoteer.roof_light": { mass: 1, size: [1, 1], cost: 0.2, tags: ["on_off", "utilities"] },
	...
	"cosmoteer.armor": { mass: 3, size: [1, 1], cost: 0.2, tags: ["defense"] },
	"cosmoteer.armor_2x1": { mass: 6, size: [2, 1], cost: 0.4, tags: ["defense"] },
	...
	"cosmoteer.armor_wedge": { mass: 1.5, size: [1, 1], cost: 0.1, tags: ["defense"] },
	...
	"cosmoteer.armor_tri": { mass: 0.75, size: [1, 1], cost: 0.05, tags: ["defense"] },
	...
	"cosmoteer.airlock": { mass: 1, size: [1, 1], cost: 0.6, tags: ["on_off", "crew_transport"] },
	"cosmoteer.conveyor": { mass: 1, size: [1, 1], cost: 0.2, tags: ["crew_transport"] },
	"cosmoteer.reactor_small": { mass: 4, size: [2, 2], cost: 25, tags: ["power"] },
	"cosmoteer.reactor_med": { mass: 9, size: [3, 3], cost: 50, tags: ["power"] },
	"cosmoteer.reactor_large": { mass: 16, size: [4, 4], cost: 75, tags: ["power"] },
	"cosmoteer.power_storage": { mass: 4, size: [2, 2], cost: 4, tags: ["power", "storage"] },
	...
	"cosmoteer.storage_2x2": { mass: 4, size: [2, 2], cost: 1.2, tags: ["storage"] },
	"cosmoteer.storage_3x2": { mass: 6, size: [3, 2], cost: 1.8, tags: ["storage"] },
	"cosmoteer.storage_3x3": { mass: 9, size: [3, 3], cost: 2.7, tags: ["storage"] },
	"cosmoteer.storage_4x3": { mass: 12, size: [4, 3], cost: 3.6, tags: ["storage"] },
	"cosmoteer.storage_4x4": { mass: 16, size: [4, 4], cost: 4.8, tags: ["storage"] },
	"cosmoteer.chaingun": {
		mass: 17.77,
		size: [3, 5],
		sprite_size: [3, 7],
