...
const spriteData = {
	...
	"cosmoteer.armor": { mass: 3, size: [1, 1], cost: 0.2, tags: ["defense", "armor"] },
	"cosmoteer.armor_2x1": { mass: 6, size: [2, 1], cost: 0.4, tags: ["defense", "armor"] },
	...
	"cosmoteer.armor_wedge": { mass: 1.5, size: [1, 1], cost: 0.1, tags: ["defense", "armor"] },
	...
	"cosmoteer.armor_tri": { mass: 0.75, size: [1, 1], cost: 0.05, tags: ["defense", "armor"] },
	...
	"cosmoteer.reactor_small": { mass: 4, size: [2, 2], cost: 25, tags: ["power", "reactor"] },
	"cosmoteer.reactor_med": { mass: 9, size: [3, 3], cost: 50, tags: ["power", "reactor"] },
	"cosmoteer.reactor_large": { mass: 16, size: [4, 4], cost: 75, tags: ["power", "reactor"] },
