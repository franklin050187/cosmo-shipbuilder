const spriteData = {
    ...
    "cosmoteer.control_room_small": { "mass": 4, "size": [2, 2], "cost": 10, "category": "command", "cp_cost": 0 },
    "cosmoteer.control_room_med": { "mass": 9, "size": [3, 3], "cost": 25, "category": "command", "cp_cost": 0 },
    "cosmoteer.thruster_small_2way": { "mass": 1.61, "size": [1, 1], "sprite_size": [2, 2], "cost": 1, "category": "thruster", "cp_cost": 2, "thrust": [0, 0.4, 0.4, 0] },
    "cosmoteer.control_room_large": { "mass": 16, "size": [4, 4], "cost": 50, "category": "command", "cp_cost": 0 },
